 ...
 */
public class RewardAdapter extends ArrayAdapter<HoneyList> {
    private Context context;
    private java.util.List<HoneyList> list;

    public RewardAdapter(Context context, java.util.List<HoneyList> list) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        textView.setText(list.get(position).getRewards());
